...
const removeHiddenText = require('./removeHiddenText')
const pdfjs = require('jsreport-pdfjs')

module.exports = (contentBuffer, { pdfMeta, pdfPassword, pdfSign, outlines } = {}) => {
  ...
  return {
    ...
    async postprocess () {
      if (pdfMeta != null || pdfPassword != null || outlines != null) {
        let newDocOpts
